...
class Index extends \Magento\Catalog\Block\Product\ListProduct
{
    ...
    public function __construct(
        ...
        $this->pageConfig->getTitle()->set(__($this
            ->_helper
            ->getConfigValue(
                'featuredproduct_settings/featured_products/title'
            )));
    }
    ...
    protected function getProducts()
    {
        ...
        $limit = $this->_helper
            ->getConfigValue(
                'featuredproduct_settings/featured_products/limit'
            );
        if ($limit == "" || $limit == 0) {
            $limit = 10;
        }
        ...
        $collection = $this->_collection
            ...
            ->addAttributeToFilter('featuredproduct', 1, 'left');

        $pager = $this->getLayout()
            ->createBlock(
                'Magento\Theme\Block\Html\Pager',
                'featuredproduct.grid.record.pager'
            )
            ->setLimit($limit)
